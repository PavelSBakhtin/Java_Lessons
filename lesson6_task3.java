// Создать структуру Кот. под вет.клинику
// Шесть данных, несколько методов.

public class lesson6_task3 {
    public static void main(String[] args) {

        String name = "BARS";
        Cat bars = new Cat("Pavel", "+3-44-44-44-44", name, "MALE",
                "MAKECOON", 2);
        ...
        System.out.println(moor.getName() + " " + moor.age + " counts");
